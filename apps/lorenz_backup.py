...
def only_for_J_forwardEuler(u, parameter, nstep, runup_step, dt):
    rho, sigma = parameter
...
if __name__ == '__main__': # pragma: no cover
    ...
    # Javg_   = []
    # grad_   = []
    # K_segment_ = np.array([1e1, 2e1, 5e1, 1e2, 2e2, 5e2, 1e3, 2e3],
            # dtype=int) #, 1e3, 2e3, 5e3, 1e4, 2e4])
