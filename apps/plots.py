...
# change T plots
# Javg_, grad_, T_, K_segment_ = pickle.load( open( "change_T.p", "rb" ) )
...
# plt.tight_layout()
# plt.savefig('T_grad_rho_dev.png')
# plt.close()
...
# plt.tight_layout()
# plt.savefig('T_grad_sigma_dev.png')
# plt.close()
